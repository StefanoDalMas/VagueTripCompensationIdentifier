...
class Parameters:
    ...
    # Drivers
    N_DRIVERS = 20
    crazyness = np.random.randint(70, 81) # Default 0, 101
    ...
    # Actual routes
    MIN_ROUTES_TO_DRIVERS: int = 100
    MAX_ROUTES_TO_DRIVERS: int = 110
    CAP_ADD_NEW_CITY: int = 70
    #Products
    MIN_PRODUCTS_TO_ADD: int = 10
    MAX_PRODUCTS_TO_ADD: int = 40
